...
module T : sig
  ...
  let name = "--- Day 1: The Tyranny of the Rocket Equation ---"
  ...
  let part1 = sum fuel_requirements
  ...
  let fuel_requirements = List.map lines ~f:(fun mass -> compute_all_fuel mass 0);;

  let part2 = (sum fuel_requirements)
